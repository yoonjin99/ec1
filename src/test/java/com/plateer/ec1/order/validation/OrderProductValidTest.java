...
public class OrderProductValidTest {
    ...
    void isExistProductTest(){
        // 1. 상품이 아예 없을때
        List<OrderProductViewVo> listPrdGoods = JsonFileReader.getObject("json/order/valid/productValid/isExistProductTest1.json", new TypeReference<List<OrderProductViewVo>>(){});
        ...
        List<OrderProductViewVo> listPrdGoods2 = JsonFileReader.getObject("json/order/valid/productValid/isExistProductTest2.json", new TypeReference<List<OrderProductViewVo>>(){});
        ...
        List<OrderProductViewVo> listPrdGoods3 = JsonFileReader.getObject("json/order/valid/productValid/isExistProductTest2.json", new TypeReference<List<OrderProductViewVo>>(){});
    ...
    void isSellingProductTest(){
        // 1. 판매중이지 x
        List<OrderProductViewVo> prd1 = JsonFileReader.getObject("json/order/valid/productValid/isSellingProductTest1.json", new TypeReference<List<OrderProductViewVo>>(){});
        OrderValidationVo vo = OrderValidationVo.builder()
        ...
        // 2. 판매중임 o
        List<OrderProductViewVo> prd2 = JsonFileReader.getObject("json/order/valid/productValid/isSellingProductTest2.json", new TypeReference<List<OrderProductViewVo>>(){});
        OrderValidationVo vo2 = OrderValidationVo.builder()
